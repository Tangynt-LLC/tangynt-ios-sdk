...
Pod::Spec.new do |s|
  s.name             = 'Tangynt'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Tangynt.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Jfmetcalf5/Tangynt'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jfmetcalf5' => 'Jfmetcalf5@gmail.com' }
  s.source           = { :git => 'https://github.com/Jfmetcalf5/Tangynt.git', :tag => s.version.to_s }
